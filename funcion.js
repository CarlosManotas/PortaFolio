...
//alert("hola mundo");
var tablero;
var playerRight = {UP: 73,DOWN: 75};
var playerLeft = {UP: 87, DOWN: 83};
...
function moverPelota(){
	...
	if (pelota.direccion == 2){
		pelota.y -= pelota.vI;
	}
	if (pelota.direccion == 3){
		pelota.x += pelota.vI;
	}
...
function inicio(){
	...
	barraRight.imagen = new  Image();
	barraRight.imagen.src = barraRight.imagenURL;
	barraRight.imagen.onload = confirmarBarraRight;

	barraLeft.imagen = new Image();
	barraLeft.imagen.src = barraLeft.imagenURL;
	barraLeft.imagen.onload = confirmarBarraLeft;

	pelota.imagen = new Image();
...
function confirmarBarraRight()
{
	barraRight.imagenOK = true;
	dibujar();
}
function confirmarBarraLeft()
{
	barraLeft.imagenOK = true;
	dibujar();
}
function confirmarPelota()
{
	pelota.imagenOK = true;
	dibujar();
}
function teclado(evento)
{
    var codigo = evento.keyCode;
    if(codigo == playerRight.UP)
    {
        barraRight.y -= barraRight.velocidad;
        
        if (barraRight.y < 0){
        	barraRight.y += barraRight.velocidad;
        }
    }
    if(codigo == playerRight.DOWN)
    {
        barraRight.y += barraRight.velocidad;
    ...
    if(codigo == playerLeft.UP)
    {
        barraLeft.y -= barraLeft.velocidad;
        
        if (barraLeft.y < 0){
        	barraLeft.y += barraLeft.velocidad;
        }
    }
    if(codigo == playerLeft.DOWN)
    {
        barraLeft.y += barraLeft.velocidad;
...
function dibujar()
{
	...
	if(barraRight.imagenOK)
	{
		tablero.drawImage(barraRight.imagen, barraRight.x, barraRight.y);
	}
	if(barraLeft.imagenOK)
	{
		tablero.drawImage(barraLeft.imagen, barraLeft.x, barraLeft.y);
	}
	if (pelota.imagenOK)
	{
